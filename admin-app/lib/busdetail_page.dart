...
import 'package:http/http.dart'
    as http; // kept for add/update/delete operations
import 'dart:convert';
...
class _BusDetailPageState extends State<BusDetailPage> {
  ...
  bool _filterRelaxed =
      false; // indicates we showed all rows because filter returned none

  String selectedShift = 'Shift 1';
  String selectedTime = 'Morning';
  List<Map<String, dynamic>> filteredBuses = [];
  bool isEditMode = false; // Global edit mode
