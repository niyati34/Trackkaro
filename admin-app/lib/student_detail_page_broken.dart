...
class _StudentDetailPageState extends State<StudentDetailPage> {
  ...
  bool isError = false;
  String? _token;
  // New strongly-typed records backing the legacy map structure
                    ...
                    onNavigate: (index) {
                      switch (index) {
                        ...
                        case 3:
                          ...
                          break;
                        case 4:
                          // Current page, do nothing or show a message
                          break;
                        case 5:
                          Navigator.pushReplacement(
                            context,
    ...
    if (isLoading) {
      return Center(
        child: Column(
          ...
          children: [
            CircularProgressIndicator(color: Color(0xFF03B0C1)),
            SizedBox(height: 16),
            Text(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(8),
                borderSide: BorderSide(color: Color(0xFF03B0C1), width: 2),
              ),
            ),
          ),
        ),
    ...
    if (filteredStudents.isEmpty) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.school, size: 64, color: Color(0xFF9CA3AF)),
            SizedBox(height: 16),
            Text(
              'No students found',
              style: GoogleFonts.dmSans(
        ...
        rows: filteredStudents.map((student) {
          return DataRow(
            cells: [
              ...
              DataCell(Text(student['bus_route'] ?? 'Not Assigned')),
              DataCell(Text(student['parent_contact'] ?? '')),
              DataCell(
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    IconButton(
                      icon: Icon(Icons.edit, size: 18, color: Color(0xFF03B0C1)),
                      onPressed: () {
                    ...
                    IconButton(
                      icon: Icon(Icons.location_on, size: 18, color: Colors.green),
                      onPressed: () {
